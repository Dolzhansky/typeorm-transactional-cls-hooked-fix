...
[![npm version](http://img.shields.io/npm/v/typeorm-transactional-cls-hooked.svg?style=flat)](https://npmjs.org/package/typeorm-transactional-cls-hooked-fix "View this project on npm")
...
```shell
npm install --save typeorm-transactional-cls-hooked-fix
## Needed dependencies
...
```typescript
import { initializeTransactionalContext } from 'typeorm-transactional-cls-hooked-fix';
...
import { BaseRepository } from 'typeorm-transactional-cls-hooked-fix';
...
```typescript
import { initializeTransactionalContext, patchTypeORMRepositoryWithBaseRepository } from 'typeorm-transactional-cls-hooked-fix';
...
```typescript
jest.mock('typeorm-transactional-cls-hooked-fix', () => ({
  Transactional: () => () => ({}),
